...
export function AdminSettingsPage() {
  ...
  const [activeTab, setActiveTab] = useState<"homepage" | "toggles" | "general">("homepage");
                  ...
                  <div className="space-y-3">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData((prev: any) => ({ ...prev, hero_headline: e.target.value }))}
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        ...
                        onChange={(e) => setFormData((prev: any) => ({ ...prev, hero_subheadline: e.target.value }))}
                        rows={2}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          onChange={(e) => setFormData((prev: any) => ({ ...prev, hero_cta_primary: e.target.value }))}
                          className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                        />
                      </div>
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          onChange={(e) => setFormData((prev: any) => ({ ...prev, hero_cta_secondary: e.target.value }))}
                          className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                        />
                      </div>
                    </div>
                      ...
                      <div className="space-y-3">
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, services_tagline: e.target.value }))}
                            className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                          />
                        </div>
                        <div className="space-y-1">
                          ...
                          <textarea
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, services_description: e.target.value }))}
                            rows={2}
                            className="w-full p-3.5 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all resize-none"
                          />
                        </div>
                      ...
                      <div className="space-y-3">
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, story_title: e.target.value }))}
                            className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                          />
                        </div>
                        <div className="space-y-1">
                          ...
                          <textarea
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, story_text: e.target.value }))}
                            rows={3}
                            className="w-full p-3.5 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all resize-none"
                          />
                        </div>
                      ...
                      <div className="space-y-3">
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, global_reach_title: e.target.value }))}
                            className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                          />
                        </div>
                        <div className="space-y-1">
                          ...
                          <textarea
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, global_reach_text: e.target.value }))}
                            rows={2}
                            className="w-full p-3.5 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all resize-none"
                          />
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, testimonials_title: e.target.value }))}
                            className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                          />
                        </div>
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, contact_title: e.target.value }))}
                            className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, twitter_url: e.target.value }))}
                            className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                        ...
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, copyright_text: e.target.value }))}
                            className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                          />
                        </div>
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, ios_app_url: e.target.value }))}
                            className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                          />
                        </div>
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, android_app_url: e.target.value }))}
                            className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                          />
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          onChange={(e) => setFormData((prev: any) => ({ ...prev, email_notify_list: e.target.value }))}
                          className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                        />
                      </div>
                      <div className="space-y-1">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, integration_whatsapp_number: e.target.value }))}
                            className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                        ...
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, integration_calendly_url: e.target.value }))}
                            className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, integration_google_reviews_embed: e.target.value }))}
                            className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                          />
                        </div>
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, rate_limit: e.target.value }))}
                            className="w-full h-10 px-4 rounded-[10px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                          />
                        </div>
                      </div>
                          ...
                          <div className="grid grid-cols-2 gap-4 pt-2">
                            <div className="space-y-1">
                              ...
                              <input
                                ...
                                onChange={(e) => setFormData((prev: any) => ({ ...prev, integration_bullhorn_api_url: e.target.value }))}
                            ...
                            <div className="space-y-1">
                              ...
                              <input
                                ...
                                onChange={(e) => setFormData((prev: any) => ({ ...prev, integration_bullhorn_client_id: e.target.value }))}
                                className="w-full h-8.5 px-3.5 rounded-[8px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                              />
                            </div>
                          </div>
                        ...
                        {formData.maintenance_mode_enabled && (
                          <div className="space-y-1 pt-2">
                            ...
                            <textarea
                              ...
                              onChange={(e) => setFormData((prev: any) => ({ ...prev, maintenance_message: e.target.value }))}
                      ...
                      <div className="p-4 border border-white/8 rounded-[12px] bg-white/2 space-y-3.5">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="space-y-1">
                            ...
                            <input
                              ...
                              onChange={(e) => setFormData((prev: any) => ({ ...prev, seo_meta_title_suffix: e.target.value }))}
                          ...
                          <div className="space-y-1">
                            ...
                            <input
                              ...
                              onChange={(e) => setFormData((prev: any) => ({ ...prev, seo_og_image_url: e.target.value }))}
                              className="w-full h-8.5 px-3 rounded-[8px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all"
                        ...
                        <div className="space-y-1">
                          ...
                          <textarea
                            ...
                            onChange={(e) => setFormData((prev: any) => ({ ...prev, seo_default_description: e.target.value }))}
                            className="w-full p-2.5 rounded-[8px] border border-white/8 bg-white/5 text-white text-xs focus:border-[#04a891]/50 outline-none transition-all resize-none"

...
import { Users, Plus, Mail, Key, Edit2, Trash2, UserCheck, X } from "lucide-react";
...
export function AdminUsersPage() {
  ...
  // Fake current user email for now (in real app, we get this from a context/JWT)
  const currentUserEmail = "admin@headhunters.com.au";
  ...
  if (loading) {
    return <div className="p-8 text-white/50">Loading users...</div>;
  }
            ...
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-white/6 pb-3 mb-2">
                  ...
                  <button type="button" onClick={resetForm} className="text-white/40 hover:text-white transition-colors cursor-pointer">
                    <X size={14} />
                  </button>
                </div>

...
echo Injecting Drizzle Auto-Migration...
...
echo Copying Drizzle schema and config...
xcopy /E /I /Q /Y /H "db" "cpanel_build\db" >nul
copy /Y "drizzle.config.ts" "cpanel_build\drizzle.config.ts" >nul

import { z } from 'zod';
import { OllamaClient, KnowledgeRetriever, ConversationRepository } from './chat-interfaces';
...
export class ChatService {
  ...
  async processUserMessage(conversationId: string, visitorId: string, msgContent: string): Promise<any> {
